...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2025]  \tab{} \textbf{Chen, Y.} and Vinayak, R. K., \enquote{Query Design for Crowdsourced Clustering: Effect of Cognitive Overload and Contextual Bias.} \textit{The Web Conference 2025 (TheWebConf 2025)}
