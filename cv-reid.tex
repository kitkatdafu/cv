...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2024] \tab{}Chen, D., \textbf{Chen, Y.}, Rege, A. and Vinayak, R. K. \enquote{PAL: Pluralistic Alignment Framework for Learning from Heterogeneous Preferences.}. \textit{The Thirteenth International Conference on Learning Representations (ICLR 2025)} 
