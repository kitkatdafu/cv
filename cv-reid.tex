...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2024]  \tab{} \textbf{Chen, Y.} and Vinayak, R. K., \enquote{Query Design for Crowdsourced Clustering: Effect of Cognitive Overload and Contextual Bias.} \textit{ICML 2024 Workshop on Models of Human Feedback for AI Alignment}

        \item[2024] \tab{}Chen, D., \textbf{Chen, Y.}, Rege, A. and Vinayak, R. K. \enquote{PAL: Pluralistic Alignment Framework for Learning from Heterogeneous Preferences.}. \textit{arXiv preprint arXiv:2406.08469}

        
        \item[2024] \tab{}Vishwakarma, H., \textbf{Chen, Y.}, Tay, S. J., Namburi, S. S. S., Sala, F., and Vinayak, R. K. \enquote{Pearls from Pebbles: Improved Confidence Functions for Auto-labeling.}. \textit{arXiv preprint arXiv:2404.16188}
        
        % \item[2024] \tab{}\textbf{Chen, Y.} and Vinayak, R. K. \enquote{Query Design for Crowdsourced Clustering: Effect of Cognitive Overload and Context.}, under review.
    ...
    \section*{Service}
    Served as Reviewer for ICLR 2025, NeurIPS 2024 Workshop on Pluralistic Alignment, ICML 2024 Workshop on Theoretical Foundations of Foundation Models, and ICML 2024 Workshop on Models of Human Feedback for AI Alignment.
